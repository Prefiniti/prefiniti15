...
<cfoutput>
	...
	#ntNotify(attributes.clientID, "WF_PROJECT_STATUS_CHANGED", "New project status (project #attributes.clientJobNumber#, #attributes.description#):#pstatval#/#attributes.SubStatus#.", "")#
