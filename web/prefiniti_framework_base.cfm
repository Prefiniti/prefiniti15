        ...
        <div class="sidebarBlock"  style="height:auto; width:240px;" id="sbWrapper">
            ...
            <div class="picWrap" align="center">
					...
					<div id="profilePicture">
                        ...
                        <a href="javascript:AjaxLoadPageToDiv('tcTarget', '/socialnet/components/search_users.cfm');">Friend Search</a> | <a href="javascript:viewPictures(#session.userid#, true);">Pictures</a><br /><a href="javascript:cmsBrowseFolder(#session.userid#, 'project_files', '', 'user', '');">My Files</a> | <a href="javascript:AjaxLoadPageToDiv('tcTarget', '/businessnet/components/my_departments.cfm');">My Departments</a> | <a href="javascript:AjaxLoadPageToDiv('tcTarget', '/scheduling/my_schedule.cfm?date=#DateFormat(Now(), "yyyy/mm/dd")#');">My Schedule</a>
