<!--
  ...
  <wwafbreadcrumbs>Prefiniti,Sites,Edit Site</wwafbreadcrumbs>
-->
...
<cfoutput query="getSiteList">
  ...
  <form name="editSite" action="/webware_admin/editSiteSubmit.cfm" method="post" target="editSiteTgt">
...
<iframe id="editSiteTgt" name="editSiteTgt"></iframe>