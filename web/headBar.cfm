<cfif #session.loggedin# EQ "yes">
    <div id="headBar">
        ...
        <a href="##"  onclick="return clickreturnvalue()" onmouseover="dropdownmenu(this, event, appMenu, '150px')" onmouseout="delayhidemenu()">
            <img src="graphics/pi-16x16.png" border="0" align="absmiddle"/></a> Prefiniti - <cfmodule template="/authentication/components/siteNameByID.cfm" id="#session.current_site_id#">
        </div>
