                ...
                <div class="dropdown profile-element">
                    ...
                    <a data-toggle="dropdown" class="dropdown-toggle" href="##">
                        <span class="block m-t-xs font-bold">                            
                            ...
                            <cfif session.impersonating EQ 1>
                    ...
                    <ul class="dropdown-menu animated fadeInRight m-t-xs">
                        ...
                        <cfif session.impersonating EQ 1>
                            <li><a class="dropdown-item" href="##" onclick="Prefiniti.Admin.impersonate(#session.originating_assoc_id#);"><i class="fa fa-mask"></i> Restore Original Identity...</a></li>                           
                        </cfif>
