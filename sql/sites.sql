...
) ENGINE=InnoDB AUTO_INCREMENT=4971 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=391 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sites` VALUES (5,'Geodigraph Social',724,1,'Prefiniti is a comprehensive business management and social networking tool developed to help companies gain an edge in a market place with standards that are driven by larger corporations.','<p>Prefiniti is a new type of web-based software developed by the owner of a land survey company in Las Cruces, New Mexico, and his friend in software design. Our first product was a basic web-based ordering system created in one afternoon for  the survey firm. From that beginning, Prefiniti evolved into its present form.</p>\r\n<p>Prefiniti provides business owners and their employees the opportunity to work more efficiently, allowing them to reach their full potential. Our pledge is to make that as easy as possible.</p>',7,'prefiniti-small.png','','','Many problems... one solution.',1,NULL,NULL,0),(6,'Test Site',724,1,'','',3,'testsite.png','','','',1,NULL,NULL,7.125),(19,'Coherent Logic Development',724,1,'','',7,NULL,'','','Solutions//Everywhere',NULL,'4B21C5DD-19B9-CB32-B7688C5B25A9511E',NULL,0),(20,'Geodigraph',725,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0),(24,'Fourth Watch BCS Inc.',724,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'CAA2DFBD-A386-4B7D-BB21915069B67912',NULL,0);
...
-- Dump completed on 2018-07-18 17:21:08
